package com.kutluoglu.demo.domain.interactor.baseUseCases
...
abstract class SingleUseCase<T, in Params> constructor (
    ...
    open fun execute(singleObserver: DisposableSingleObserver<T>, params: Params? = null) {
        ...
        addDisposible(single.subscribeWith(singleObserver))
    }
     ...
     * Dispose from current [CompositeDisposable].
     */
    private fun addDisposible (disposible: Disposable) {
